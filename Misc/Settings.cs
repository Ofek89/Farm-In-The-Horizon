...
public static class Settings 
{
    ...
    //Player
    public static float playerCentreYOffset = 0.875f; //used as reference for non grid cursor, to determine the pivot point at the centre of the player
    ...
    public static int playerMaximumInventoryCapacity = 36; //48
    ...
    // Shared Animation Parameters Between the Player and NPC's
    ...
    public const string FishingTool = "Fishing Rod";
    ...
    //Time System
    public const float secondsPerGameSecond = 0.01f; //0.12f;
