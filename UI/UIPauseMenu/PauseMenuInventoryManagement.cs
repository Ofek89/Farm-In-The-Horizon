...
//this script is attached to the Tab0InventoryManagement on our Canvas
public class PauseMenuInventoryManagement : MonoBehaviour
{
    ...
    {
        EventHandler.InventoryUpdatedEvent += PopulatePlayerInventory; //this triggers each time we switch an item on the inventory
    ...
    //populates all the inventory slots on our inventory management screen
