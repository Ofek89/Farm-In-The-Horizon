...
public class CropDetails
{
    ...
    //public int totalGrowthDays; //total growth days - sum of all growth days
    ...
    public bool CanUseToolToHarvestCrop(int toolItemCode)
    {
        ...
        {
            return false; //if equal to -1, cant use that tool to harvest crop
        }
        else
        {
            return true; //if its not equal to -1, can use that tool
        }
