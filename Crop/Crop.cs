...
public class Crop : MonoBehaviour
{
    ...
    //this is a child of cropStandard prefab, which is used by the animator parent to show the harvested animation of a crop
    ...
    private void HarvestCrop(bool isUsingToolRight, bool isUsingToolUp, CropDetails cropDetails, GridPropertyDetails gridPropertyDetails, Animator animator)
    {
        ...
        {
            // If harvest sprite then add to sprite renderer child game object on the cropStandard prefab
        ...
        // Should box colliders be disabled before harvest (prevent the collide of the item to collide with the player when we harvest the crop)
    ...
    //checks if the harvested state in the animation has reached yet or not
    private IEnumerator ProcessHarvestActionsAfterAnimation(CropDetails cropDetails, GridPropertyDetails gridPropertyDetails, Animator animator)
    {
        ...
        HarvestActions(cropDetails, gridPropertyDetails); //trigger HarvestAction when animatior reached Harvested part
    }
    ...
    {
        // Update crop in grid properties for the transform crop
