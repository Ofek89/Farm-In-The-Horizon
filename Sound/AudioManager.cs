...
public class AudioManager : SingletonMonobehaviour<AudioManager>
{
    ...
    public void PlaySound(SoundName soundName)
    {
        if (soundDictionary.TryGetValue(soundName, out SoundItem soundItem) && soundPrefab != null)
        {
            ...
            sound.SetSound(soundItem); //sets pitch and volume declared for that sound 
            soundGameObject.SetActive(true); //play the sound, because the sound is play on awake
