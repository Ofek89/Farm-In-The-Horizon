...
public class PoolManager : SingletonMonobehaviour<PoolManager>
{
    ...
    [SerializeField] private Pool[] pool = null; //an array of pools, each has an int key and a preab as value
    [SerializeField] private Transform objectPoolTransform = null; //objectPool gameobject transform, just to keep the item we pool under the same pool
    ...
    private void Start()
    {
        // Create object pools on start, for each array in our pool array 
    ...
    {
        int poolKey = prefab.GetInstanceID(); //used as a key for the dictionary
